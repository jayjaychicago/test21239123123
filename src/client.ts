...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['TEST21239123123_BASE_URL'].
   */
...
export class Test21239123123 {
   ...
   * API Client for interfacing with the Test21239123123 API.
   *
   * @param {string} [opts.baseURL=process.env['TEST21239123123_BASE_URL'] ?? https://localhost:8080/test-api] - Override the default base URL for the API.
   ...
   */
  constructor({ baseURL = readEnv('TEST21239123123_BASE_URL'), ...opts }: ClientOptions = {}) {
  ...
  protected stringifyQuery(query: Record<string, unknown>): string {
    return Object.entries(query)
      ...
      .map(([key, value]) => {
        ...
        throw new Errors.Test21239123123Error(
  ...
  static Test21239123123 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Test21239123123Error = Errors.Test21239123123Error;
  ...
  cars: API.Cars = new API.Cars(this);
}
Test21239123123.Cars = Cars;
export declare namespace Test21239123123 {
