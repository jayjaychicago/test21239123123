...
import { APIPromise } from 'test21239123123/core/api-promise';

import util from 'node:util';
import Test21239123123 from 'test21239123123';
import { APIUserAbortError } from 'test21239123123';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['TEST21239123123_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Test21239123123) => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new Test21239123123({ logger: logger, logLevel: 'debug' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Test21239123123({ logger: logger, logLevel: 'info' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['TEST21239123123_LOG'] = 'debug';
      const client = new Test21239123123({ logger: logger });
    ...
    test('warn when env var level is invalid', async () => {
      ...
      process.env['TEST21239123123_LOG'] = 'not a log level';
      const client = new Test21239123123({ logger: logger });
      expect(client.logLevel).toBe('warn');
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'TEST21239123123_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['TEST21239123123_LOG'] = 'debug';
      const client = new Test21239123123({ logger: logger, logLevel: 'off' });
  ...
  test('explicit global fetch', async () => {
    ...
    const client = new Test21239123123({ baseURL: 'http://localhost:5000/', fetch: defaultFetch });
  });
  ...
  test('normalized method', async () => {
    ...
    const client = new Test21239123123({ baseURL: 'http://localhost:5000/', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Test21239123123({ baseURL: 'http://localhost:5000/custom/path/' });
    ...
    afterEach(() => {
      process.env['TEST21239123123_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Test21239123123({ baseURL: 'https://example.com' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['TEST21239123123_BASE_URL'] = 'https://example.com/from_env';
      const client = new Test21239123123({});
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['TEST21239123123_BASE_URL'] = ''; // empty
      const client = new Test21239123123({});
      expect(client.baseURL).toEqual('https://localhost:8080/test-api');
    });

    test('blank env variable', () => {
      process.env['TEST21239123123_BASE_URL'] = '  '; // blank
      const client = new Test21239123123({});
      expect(client.baseURL).toEqual('https://localhost:8080/test-api');
    });
  });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Test21239123123({ maxRetries: 4 });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Test21239123123({});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Test21239123123({ timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Test21239123123({ fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Test21239123123({ fetch: testFetch });
